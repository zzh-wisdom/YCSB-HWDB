...
#cmd="./ycsbc -db hwdb -dbpath $dbpath -threads 4 -P $zipfian_workload -run true -dbstatistics false "
cmd="./ycsbc -db hwdb -dbpath $dbpath -threads 4 -P $workload -load true -run true -morerun $moreworkloads -dbstatistics false "
